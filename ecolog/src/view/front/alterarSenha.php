...
<html lang=pt-br>
    ...
    <body>
        ...
        <div id="boxAlteraSenhaUsuario">
            <h1>Alterar Senha</h1>

            <div class="login">

                <form action="" method="POST" class="configAlteracao">
                    <fieldset>
                        <input type="hidden" name="txtAcao" id="txtAcao" value="3" >

                        <div class="campo">
                            <label>Senha atual:</label>
                            <input type="password" class="tamanho-campo" name="txtSenhaUsuario" id="txtSenhaUsuario" required>
                        </div>
